...
SOURCES = \
	__init__.py \
	korekurver.py korekurver_dockwidget.py

PLUGINNAME = korekurver

PY_FILES = \
	__init__.py \
	korekurver.py korekurver_dockwidget.py

UI_FILES = korekurver_dockwidget_base.ui
...
QGISDIR=C:\Users\StavroulaBourmetsika\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
